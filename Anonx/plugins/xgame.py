...
GAME_BUTTONS = [
    [ 
        ...
        InlineKeyboardButton ('✘ ✘', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ ✘ • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡️', url =f"https://t.me/C_U_U_1")              
                 ],[
          ...
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_BUTTONS = [
                 [
                    ...
                    InlineKeyboardButton (
                        "°القط المجنون°" , url=f"http://t.me/gamee?game=✘azyCat"),
                ],[
                    InlineKeyboardButton (
                        "◁" , callback_data= 'GAME')
                  ],
